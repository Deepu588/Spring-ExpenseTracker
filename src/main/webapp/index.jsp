...
<body>
<div class="header">
   <img src="media/expenses-removebg-preview (1).png" style="height:51px;width:50px;padding:22px;margin-left:33px;">     <b>Spring Expenses Tracker</b>
    ...
    <div id="mt">
    					...
    					<i class="sm">Expense Tracker is used by user's to record their daily routine expenses in a digital and hassle-free way as opposed to the conventional manual documentation of expenses</i>
    </div>
</body>
</html>